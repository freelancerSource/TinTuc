    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li class="active treeview">
                <a href="#">
                    <i class="fa fa-dashboard"></i> <span>Movies news</span>
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-files-o"></i><span>Photos</span>
                    <span class="pull-right-container">
            ...
            <li>
                <a href="trailer">
                    <i class="fa fa-th"></i> <span>Trailer</span>
                    <span class="pull-right-container">
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-pie-chart"></i><span>Celebrities</span>
                    <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                </a>
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-edit"></i> <span>User manage</span>
                    <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                </a>
